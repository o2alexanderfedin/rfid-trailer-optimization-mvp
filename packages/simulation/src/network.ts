...
/**
 * SIM-01: the Phase-1 USA hub network. Real US metro hubs with WGS84
 * coordinates. Memphis is the canonical Phase-1 skeleton hub (the world's
 * busiest cargo airport / classic middle-mile sort hub).
 *
 * This list is a static, deterministic constant — no clock, no RNG — so the
 * resulting event stream is reproducible.
 */
export const USA_HUBS: readonly Hub[] = [
  ...
  { hubId: "MIA", name: "Miami", lat: 25.7617, lon: -80.1918 },
] as const;

/** The canonical single hub the Phase-1 walking skeleton renders. */
