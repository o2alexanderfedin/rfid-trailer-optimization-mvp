...
**Plans**: 6 plans
Plans:
- [ ] 04-01-PLAN.md — Domain: add PlanGenerated/PlanAccepted to the closed event union + zod + contract.assert (OPT-04)
- [ ] 04-02-PLAN.md — Scaffold @mm/optimizer (pure core; reuses @mm/load-planner; glpk.js devDep) + time-expanded hub graph (OPT-01)
- [ ] 04-03-PLAN.md — Min-cost flow: pure-TS Successive Shortest Path + glpk.js exact-LP oracle keystone + freight assignment (OPT-02)
- [ ] 04-04-PLAN.md — VRPTW: cheapest-insertion construction + 2-opt/or-opt local search; loads gated by reused validatePlan (OPT-03)
- [ ] 04-05-PLAN.md — Weighted objective + feasibility-hard-gate keystone selection + local repair split/reassign/hold/over-carry (OPT-07, OPT-08)
- [ ] 04-06-PLAN.md — Rolling shell: scoped epoch + structuredClone twin sandbox + freeze/idempotency keystone + @mm/api service/endpoint (OPT-04, OPT-05, OPT-06)
...
| 4. Rolling Optimizer | 0/6 | Planned | - |
