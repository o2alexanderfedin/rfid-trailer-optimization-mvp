...
**Plans**: 3 plans
Plans:
- [ ] 26-01-PLAN.md — Pure in-fold optimizer adapter: buildCenterTwinFromFold + epochResultToRerouteSuggestions (reroute-only, scope-size-invariant, pure)
...
| 26. Coordinator ↔ Optimizer | 0/3 | Not started | - |
